...
from transfuser_convnext.model import TransFuserConvnext
from transfuser_convnext.config import GlobalConfig
from transfuser_convnext.data import scale_and_crop_image, lidar_to_histogram_features, transform_2d_points
...
def get_entry_point():
	return 'TransFuserConvnextAgent'


class TransFuserConvnextAgent(autonomous_agent.AutonomousAgent):
	def setup(self, path_to_conf_file):
		...
		self.net = TransFuserConvnext(self.config, 'cuda')
