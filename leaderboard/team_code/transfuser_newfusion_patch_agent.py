...
from transfuser_newfusion_patch.model import TransFuserNewFusionPatch
from transfuser_newfusion_patch.config import GlobalConfig
from transfuser_newfusion_patch.data import scale_and_crop_image, lidar_to_histogram_features, transform_2d_points
...
def get_entry_point():
	return 'TransFuserNewFusionPatchAgent'


class TransFuserNewFusionPatchAgent(autonomous_agent.AutonomousAgent):
	def setup(self, path_to_conf_file):
		...
		self.net = TransFuserNewFusionPatch(self.config, 'cuda')
