...
from transfuser_patch.model import TransFuserPatch
from transfuser_patch.config import GlobalConfig
from transfuser_patch.data import scale_and_crop_image, lidar_to_histogram_features, transform_2d_points
...
def get_entry_point():
	return 'TransFuserPatchAgent'


class TransFuserPatchAgent(autonomous_agent.AutonomousAgent):
	def setup(self, path_to_conf_file):
		...
		self.net = TransFuserPatch(self.config, 'cuda')
