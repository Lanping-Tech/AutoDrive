...
from transfuser_se.model import TransFuserSE
from transfuser_se.config import GlobalConfig
from transfuser_se.data import scale_and_crop_image, lidar_to_histogram_features, transform_2d_points
...
def get_entry_point():
	return 'TransFuserSEAgent'


class TransFuserSEAgent(autonomous_agent.AutonomousAgent):
	def setup(self, path_to_conf_file):
		...
		self.net = TransFuserSE(self.config, 'cuda')
