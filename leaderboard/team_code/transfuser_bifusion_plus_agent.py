...
from transfuser_bifusion_plus.model import TransFuserBiFusionPlus
from transfuser_bifusion_plus.config import GlobalConfig
from transfuser_bifusion_plus.data import scale_and_crop_image, lidar_to_histogram_features, transform_2d_points
...
def get_entry_point():
	return 'TransFuserBiFusionPlusAgent'


class TransFuserBiFusionPlusAgent(autonomous_agent.AutonomousAgent):
	def setup(self, path_to_conf_file):
		...
		self.net = TransFuserBiFusionPlus(self.config, 'cuda')
