...
from transfuser_cross.model import TransFuserCross
from transfuser_cross.config import GlobalConfig
from transfuser_cross.data import scale_and_crop_image, lidar_to_histogram_features, transform_2d_points
...
def get_entry_point():
	return 'TransFuserCrossAgent'


class TransFuserCrossAgent(autonomous_agent.AutonomousAgent):
	def setup(self, path_to_conf_file):
		...
		self.net = TransFuserCross(self.config, 'cuda')
