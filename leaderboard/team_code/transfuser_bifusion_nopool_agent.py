...
from transfuser_bifusion_nopool.model import TransFuserBiFusionNoPool
from transfuser_bifusion_nopool.config import GlobalConfig
from transfuser_bifusion_nopool.data import scale_and_crop_image, lidar_to_histogram_features, transform_2d_points
...
def get_entry_point():
	return 'TransFuserBiFusionNoPoolAgent'


class TransFuserBiFusionNoPoolAgent(autonomous_agent.AutonomousAgent):
	def setup(self, path_to_conf_file):
		...
		self.net = TransFuserBiFusionNoPool(self.config, 'cuda')
