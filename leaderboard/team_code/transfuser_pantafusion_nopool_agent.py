...
from transfuser_pentafusion_nopool.model import TransFuserPentaFusionNoPool
from transfuser_pentafusion_nopool.config import GlobalConfig
from transfuser_pentafusion_nopool.data import scale_and_crop_image, lidar_to_histogram_features, transform_2d_points
...
def get_entry_point():
	return 'TransFuserPentaFusionNoPoolAgent'


class TransFuserPentaFusionNoPoolAgent(autonomous_agent.AutonomousAgent):
	def setup(self, path_to_conf_file):
		...
		self.net = TransFuserPentaFusionNoPool(self.config, 'cuda')
