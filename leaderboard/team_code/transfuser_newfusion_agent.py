...
from transfuser_newfusion.model import TransFuserNewFusion
from transfuser_newfusion.config import GlobalConfig
from transfuser_newfusion.data import scale_and_crop_image, lidar_to_histogram_features, transform_2d_points
...
def get_entry_point():
	return 'TransFuserNewFusionAgent'


class TransFuserNewFusionAgent(autonomous_agent.AutonomousAgent):
	def setup(self, path_to_conf_file):
		...
		self.net = TransFuserNewFusion(self.config, 'cuda')
