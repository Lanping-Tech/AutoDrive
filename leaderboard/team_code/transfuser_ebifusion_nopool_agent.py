...
from transfuser_ebifusion_nopool.model import TransFuserEBiFusionNoPool
from transfuser_ebifusion_nopool.config import GlobalConfig
from transfuser_ebifusion_nopool.data import scale_and_crop_image, lidar_to_histogram_features, transform_2d_points
...
def get_entry_point():
	return 'TransFuserEBiFusionNoPoolAgent'


class TransFuserEBiFusionNoPoolAgent(autonomous_agent.AutonomousAgent):
	def setup(self, path_to_conf_file):
		...
		self.net = TransFuserEBiFusionNoPool(self.config, 'cuda')
